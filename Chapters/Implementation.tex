...
\begin{figure}[ht]
    ...
    \subfloat[\centering Svíčkový graf s anotacemi průběhu iterací]{{\includegraphics[width=0.45\textwidth]{Figures/web/trade-order-detail-candles.png}}\label{subfig:web:candles}}
