...
Nejzákladnější a nejčastěji volaný koncový bod rozhraní slouží k vytvoření nového příkazu na burze.
\newline
\verb|POST /api/v3/order|
\begin{center}
    \begin{longtable}[h]{|l|m{4cm}|m{4cm}|m{4cm}|}
        \hline
...
\begin{center}
    \begin{longtable}[h]{|l|c|c|m{3.7cm}|}
        ...
        \hline
        stopLimitTimeInForce & Pokud je stopLimitPrice & ENUM(gtc, ioc, fok) &                                           \\
        \hline
        trailingDelta        & \tikzxmark              & Celočíselný         &                                           \\
        \hline
        \caption{Parametry pro zrušení příkazu}
