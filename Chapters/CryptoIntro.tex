...
\begin{figure}[ht]
    \centering
    \subfloat[\centering Spojnivový graf]{{\includegraphics[width=0.45\textwidth]{Figures/linechart.pdf}}}
    \qquad
    \subfloat[\centering Sloupcový graf]{{\includegraphics[width=0.45\textwidth]{Figures/barchart.pdf}}}

    \subfloat[\centering Svíčkový graf]{{\includegraphics[width=0.45\textwidth]{Figures/candlestickchart.pdf}}}
    \qquad
...
\begin{figure}[ht]
    \centering
    \subfloat[\centering Oblast pro nákup]{{\includegraphics[width=0.45\textwidth]{Figures/limit-chart-buy.pdf}}}
    \qquad
    \subfloat[\centering Oblast pro prodej]{{\includegraphics[width=0.45\textwidth]{Figures/limit-chart-sell.pdf}}}

    \subfloat[\centering Stop limit nákup]{{\includegraphics[width=0.45\textwidth]{Figures/stop-limit.pdf}}}
    \qquad
    \subfloat[\centering Trailing]{{\includegraphics[width=0.45\textwidth]{Figures/trailing-delta.pdf}}}
