...
Aktiva musí nejdříve nakoupit a následným uzavřením pozice je prodá se ziskem.
...
Tedy očekává, že po uzavření pozice bude mít více kryptoměny než v době, kdy ji prodával, protože její cena se snížila.
Během shortování obchodník aktivum nikdy nevlastní, ale má je \enquote{vypůjčené} od brokera, tuto výpůjčku následně vrátí a získané přebytky si nechá.
